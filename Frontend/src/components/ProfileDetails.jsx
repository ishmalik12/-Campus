...
const ProfileDetails = () => {
  ...
  // Sample Profile for a College Student
  const sampleProfile = {
    fullName: "Love Maggo",
    rating: 4.5,
    worksDone: 12,
    badges: ["Math Tutoring", "Physics Assistance"],
    bio: "I am a college student with a passion for helping my peers with their studies, particularly in subjects like Math and Physics. I believe in creating an interactive learning experience and helping students understand complex concepts in simple ways.",
    typeOfWork: "Tutoring",
      ...
      <div className="container my-5">
        ...
        <div className="card border-0 p-4 mb-4 shadow-sm">
          <div className="d-flex align-items-center mb-4">
            ...
            <div>
              <h2 className="mb-1">{sampleProfile.fullName}</h2>
              <div className="d-flex text-muted">
                <FaStar className="text-warning me-2" /> {sampleProfile.rating} Rating
                <FaBriefcase className="text-success ms-4 me-2" /> {sampleProfile.worksDone} Works Done
              </div>
            </div>
          </div>
          ...
          <div className="mb-4">
            <h4>About </h4>
            <p>
              {sampleProfile.fullName} is a college student with expertise in {sampleProfile.badges.join(', ')}.
              Known for delivering excellent tutoring sessions and making difficult topics easy to understand, they specialize in providing assistance with Math and Physics.
            </p>
          </div>
                        ...
                        onClick={() =>
                          navigate('/paymentpage', {
                            state: {
                              ...
                              orderId: "order123",
                              profileId,
                              profileName: `${sampleProfile.fullName}`,
                              userName,
                              userId
                            },
                          })
